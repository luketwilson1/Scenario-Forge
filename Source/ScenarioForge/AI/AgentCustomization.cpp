...
/**
 * @file AI/AgentCustomization.cpp
...
const FMeleeProperties& UAgentCustomization::GetResolvedMeleeProperties() const
{
	TSet<const UAgentCustomization*> Visited;
...
const FMeleeProperties& UAgentCustomization::GetResolvedMeleeProperties(TSet<const UAgentCustomization*>& Visited) const
{
