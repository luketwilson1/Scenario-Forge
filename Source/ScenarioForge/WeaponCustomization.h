...
#include "WeaponCustomization.generated.h"
...
class SCENARIOFORGE_API UWeaponCustomization : public UDataAsset
{
	GENERATED_BODY()
...
public:
	...
	TObjectPtr<UProjectileCustomization> ProjectileCustomization;
