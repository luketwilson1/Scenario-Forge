...
#include "EquipmentCustomization.generated.h"
...
class SCENARIOFORGE_API UEquipmentCustomization : public UDataAsset
{
	GENERATED_BODY()
...
public:
	...
	/** Projectile customization spawned when UseBehavior is Spawn Projectile. */
	...
	TObjectPtr<UProjectileCustomization> ProjectileToSpawn;
